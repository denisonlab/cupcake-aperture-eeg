...
p.nReps = 24; % 6 reps with 32 trials/rep -> 3 blocks
...
p.gratingSF = 1.5; % cpd
p.gratingOrientations = [0 90]; %0:22.5:179; %0:5:179; %0:20:179; %0:22.5:179
p.gratingPhases = [0 pi/2 pi 3*pi/2]; % eg. 0, or [0 pi/2 pi 3*pi/2]
p.gratingContrasts = 1; 
p.noiseContrasts = [0.2 0.5]; 
p.aperture = 'cosine-ring'; % disk:'cosine', annulus:'cosine-ring', concentric:'radial-sine-ring', roth:'vignette-ring'
